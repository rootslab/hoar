...
exports.Hoar = ( function () {
    var log = console.log
        ...
        , checkPre = function ( pv, pw, cond ) {
            ...
            for ( ; i < lmin; ++i ) {
                ...
                if ( pvtype !== pwtype ) {
                    // if true ? v > w : v < w
                    return answer( c, pvtype === 'string' ? true : false );
                }
                // same type
                if ( pvnum === pwnum ) {
    ...
    return {
        ...
        , parse : parse
        , print : print
        , range : function ( v, vrange, opt ) {
            var vr = isArray( vrange ) ? vrange : []
                , r1 = vr[ 0 ] || - Infinity
                , r2 = vr[ 1 ] || +Infinity
                , maj = '>'
                , min = '<'
            ...
            log( v, maj, r1, compare( v, r1, maj ) );
            log( v, min, r2, compare( v, r2, min ), '\n' );
            return compare( v, r1, maj ) && compare( v, r2, min );
        }
    };
